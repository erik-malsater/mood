(function($) {          
    $(document).ready(function(){
        ...
        $('#dropdown_search_form_field').focus(function(){
            if(!$(this).hasClass('dropdown_search_form_field')){
                $(this).toggleClass('header_search_form_field_filled');
                var x = $('#other_pages_dropdown_search_form_button_image').attr('src');
                if(x === '../images/search_icon_black.png'){
                    $('#other_pages_dropdown_search_form_button_image').attr('src', '../images/search_icon_orange.png');
                } else{
                    $('#other_pages_dropdown_search_form_button_image').attr('src', '../images/search_icon_black.png');
                }
            }
        });
        /*
